                  ...
                  <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0 py-2">
                    ...
                    >
                      <LoginForm
                        ...
                        isVisibleLogInForm={isVisibleLogInForm}
                    ...
                    <div
                      ...
                      className="fixed top-0 left-0 z-30 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800"
                      tabIndex="-1"
                        ...
                        <ul className="space-y-2 font-medium">
                          ...
                          <li className="group relative flex justify-center">
                            <div>
                              <button
                                type="button"
                                className="flex justify-center py-3 flex items-center text-xs sm:text-sm md:text-base font-medium text-gray-900 hover:text-gray-600 dark:text-white dark:hover:text-primary-500"
                                style={{ fontSize: "1rem" }}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-8">
                        ...
                        <div
                          className="hidden divider h-[35px] md:h-[50px] bg-black"
                          style={{ width: "1px" }}
                        >
                          {/* Divider */}
                        </div>
                      ...
                      <div className="flex items-center lg:space-x-2">
                        <MyCartButton
                          handleShoppingCartClicked={handleShoppingCartClicked}
                        />
