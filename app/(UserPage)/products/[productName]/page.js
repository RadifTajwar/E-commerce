      ...
      <div className="productIdCart my-2">
        <div className="upper_part max-w-7xl mx-auto px-4">
                  ...
                  >
                    <CarouselContent className="-ml-1">
                      {images.map((image, index) => (
                        <CarouselItem
                          key={index}
                          className="pl-1 basis-1/3 sm:basis-1/4 "
                        >
                          <div className="p-0">
            ...
            <div className=" three hidden md:block md:w-1/2 lg:w-2/6   border border-px shadow ms-5">
              <div className="inner px-10 py-12 w-full h-full ">
                <div className="txt space-y-2 mb-4">
                  <h1 className="text-3xl font-normal text-center text-gray-800">
                    {productData?.name}
                  </h1>
                ...
                <div className="color_section items-center justify-center relative">
                  ...
                  <div className="rangeBar h-auto flex items-center space-x-2 justify-center mb-2">
                    ...
                    <div
                      className={`text-center clear_button ms-2 ${
                        selectedColor ? "block" : "hidden"
                      }`}
                    >
                      <button
                ...
                <div className="OutOfStock Text">
                  {outOfStock && (
                    <p className="text-center text-red-800 text-xl font-semibold">
                      Out of Stock
                    </p>
                  )}
                </div>
                ...
                <div className="quantity_section flex justify-center">
                  <div className="inner flex my-4">
                    ...
                    {/* Quantity Display */}
                    <span className="px-3 py-3 border-t-2 border-b-2">
                      {quantity}
                    </span>
                  ...
                  >
                    <button
                      className={`text-center w-full py-3 text-sm font-medium ${
                        !productData?.inStock || outOfStock
                          ? "cursor-not-allowed"
                          : ""
                      }`}
                ...
                <div className="product_detail my-6">
                  ...
                  <div className="w-full flex justify-between items-center py-4">
                    ...
                    <div className="detail_type">
                      <p className="text-sm text-gray-500 font-normal">
                        {productData?.productDetails?.warranty}
                      </p>
                    </div>
                  </div>
                  <div className="line w-full border-t border-gray-300 "></div>
                    ...
                    <div className="detail_type">
                      ...
                      <p className="text-sm text-gray-500 font-normal">
                        {productData?.color?.map((color, index) => (
                          <span key={color.id}>
                            {color?.colorName}
                            {index < productData?.color?.length - 1 && ", "}
                          </span>
                        ))}
                      </p>
                    </div>
                ...
                <div className="product_caption w-full ">
                  <p className="text-sm text-gray-500 font-normal text-center">
                    Your everyday job will be easier if you keep all of your
                    paperwork, file, documents, tabs up to 10 inches,
                    checkbooks, certificates, business cards, and pencils in an
                    A4 file bag. Cowhide is used to create the bag, which has a
                    long lifespan.
                  </p>
                </div>
              </div>
          ...
          <div className=" three w-full  md:hidden border border-px shadow ">
            <div className="inner px-10 py-12 w-full h-full ">
              <div className="txt space-y-2 mb-4">
                <h1 className=" text-lg md:text-xl xl:text-3xl font-normal text-center text-gray-800">
                  A4 File Bag Series 2
                </h1>
                <p className="text-center">
                  <span
                  ...
                  <span
                    className="md:text-lg lg:text-xl text-gray-700 font-medium"
                    style={{ marginLeft: "8px" }}
                  >
                    $3500.00
                  </span>
              ...
              <div className="color_section flex items-center justify-center space-x-4">
                <div className="">
                  <p className="text-center text-gray-800  text-md font-semibold">
                    Color :
                  </p>
                </div>
              ...
              <div className="Add_to_cart&Buy_now space-y-2">
                ...
                <div className="text-center buttons_BUY_NOW bg-black  text-white">
                  <button className="text-center w-full py-3 text-sm font-medium">
                    BUY NOW
                  </button>
                </div>
              </div>
              ...
              <div className="product_caption w-full ">
                <p className="text-sm text-gray-500 font-normal text-center">
                  Your everyday job will be easier if you keep all of your
                  paperwork, file, documents, tabs up to 10 inches, checkbooks,
                  certificates, business cards, and pencils in an A4 file bag.
                  Cowhide is used to create the bag, which has a long lifespan.
                </p>
              </div>
            </div>
          </div>
