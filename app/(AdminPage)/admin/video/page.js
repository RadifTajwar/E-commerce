  ...
  return (
    <>
      ...
      <div className=" max-w-2xl md:max-w-3xl lg:max-w-7xl grid px-6 mx-auto overflow-x-auto">
        ...
        <AllVideoBanners toggleDeleteVisible={toggleDeleteVisible} toggleVisibility={toggleVisibility} />
      ...
      >
        <UpdateVideoBanner toggleVisibility={toggleVisibility} id={idRef.current} resetId={resetId} 
