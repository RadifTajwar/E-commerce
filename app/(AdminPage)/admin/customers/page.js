      ...
      <div className="max-w-4xl lg:max-w-7xl grid px-6 mx-auto">
          ...
          <div className="p-4">
            <form className="py-3 grid gap-4 lg:gap-6 xl:gap-6 md:flex xl:flex">
              <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
                <input
                  className="block w-full px-3 py-1 text-sm focus:outline-none dark:text-gray-300 leading-5 rounded-md focus:border-gray-200 border border-gray-300 dark:border-gray-600 bg-gray-100 dark:focus:border-gray-500 dark:focus:ring-gray-300 dark:bg-gray-700 border h-12 text-sm focus:outline-none block w-full  border-transparent focus:bg-white"
                  type="search"
                  name="search"
        ...
        <div className="text-center align-middle mx-auto p-5 my-5">
          ...
          <h2 className="text-lg md:text-xl lg:text-2xl xl:text-2xl text-center mt-2 font-medium font-serif text-gray-600">
            Sorry, we can not find this Sorry, There are no customers right now.
