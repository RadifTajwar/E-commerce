...
export default function deleteVisible({
  ...
  const {
    ...
    error: categoryError,
  } = useSelector((state) => state.orderById);
        ...
        <div data-focus-lock-disabled="false">
          ...
          <div className="mb-6 text-sm text-gray-700 dark:text-gray-400 text-center custom-modal px-8 pt-6 pb-4">
            ...
            <h2 className="text-xl font-medium mb-2">
              Are You Sure! Want to Cancel this Order No{" "}
              <span className="text-red-500">{categoryName}</span>?
            </h2>
            <p>
              Do you really want to cancel these order? You can't review the
              order once its been cancelled!
            </p>
          </div>
