...
export default function addProduct({
  ...
  } = useSelector((state) => state.createNewProduct);
  ...
  const handleColorChange = (e, index, field) => {
    ...
    if (field === "colorName")
      updatedAdditionalDetails[index].color = e.target.value;
    if (field === "hex") updatedAdditionalDetails[index].hex = e.target.value;
    if (field === "availableQuantity")
      updatedAdditionalDetails[index].quantity =
  ...
  const handleRemoveImage = (colorIndex, imageIndex) => {
    const updatedAdditionalDetails = [...formData.additionalDetails];
    updatedAdditionalDetails[colorIndex].images = updatedAdditionalDetails[
      colorIndex
    ].images.filter((_, idx) => idx !== imageIndex);
    updatedAdditionalDetails[colorIndex].imagesPreview =
      updatedAdditionalDetails[colorIndex].imagesPreview.filter(
  ...
  const handleRemoveColor = (index) => {
    ...
    const updatedAdditionalDetails = formData.additionalDetails.filter(
      (_, i) => i !== index
    );
                              ...
                              categories.map((parentCategory) => (
                                <li key={parentCategory.id}>
                                  <a
                                    ...
                                    onClick={() =>
                                      handleCategorySelect(parentCategory.name)
                        ...
                        >
                          <div className="grid grid-cols-12 gap-2 mb-2">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleColorChange(e, index, "colorName")
                              }
                            />
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleColorChange(e, index, "availableQuantity")
                              }
                            />
                          ...
                          <div className="mt-4">
                            ...
                            {formData.additionalDetails[index]?.imagesPreview &&
                              formData.additionalDetails[index].imagesPreview
                                .length > 0 && (
                                <aside className="flex flex-row flex-wrap mt-4">
                                  {formData.additionalDetails[
                                    index
                                  ].imagesPreview.map((image, imgIndex) => (
                                    <div
                                      key={imgIndex}
                      ...
                      {formData.leather && (
                        <>
                          ...
                          {formData.leather.title?.map((title, index) => {
                            return (
                              // Ensure you use 'return' to return the JSX
                              <div
                                key={index}
                                className="bg-gray-50 border rounded-md p-4 mb-4"
                              >
                  ...
                  <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                    ...
                    <div className="col-span-8 sm:col-span-4">
                      <div className="flex flex-row">
                        ...
                        <input
                          className="block w-full px-3 py-1 text-sm focus:outline-none dark:text-gray-300 leading-5 rounded-md focus:border-gray-200 border-gray-200 dark:border-gray-600 focus:ring focus:ring-green-300 dark:focus:border-gray-500 dark:focus:ring-gray-300 dark:bg-gray-700 bg-gray-50 mr-2 rounded  h-12 p-2  border  focus:bg-white focus:border-blue-500 focus:outline-none rounded-l-none"
                          type="text"
                ...
                <div className="bottom_section absolute z-10 bottom-0 w-full right-0 pt-4 pb-32 lg:pb-4 lg:py-8 px-6 grid gap-4 lg:gap-6 xl:gap-6 md:flex xl:flex bg-gray-50 border-t border-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
                  ...
                  <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
                    <button
                      ...
                      type="submit"
                      disabled={createProductLoading || imageUploading}
                    >
                      <span>
                        {" "}
                        {createProductLoading || imageUploading
                          ? "Creating..."
                          : "Create Product"}
                      </span>
                    </button>
