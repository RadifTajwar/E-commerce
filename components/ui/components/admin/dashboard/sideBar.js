                ...
                <div className="py-4 text-gray-500 dark:text-gray-400">
                    ...
                    <ul className="mt-6">
                        ...
                        <li className="relative px-6 py-3">
                            <button className="inline-flex items-center justify-between focus:outline-none w-full text-sm font-semibold transition-colors duration-150 hover:text-blue-600 dark:hover:text-gray-200" aria-haspopup="true" onClick={() => { setCatalogButtonForm(!catalogButtonForm) }}>
                                    ...
                                    <>
                                        <ul className="p-2  overflow-hidden text-sm font-medium text-gray-500 rounded-md dark:text-gray-400 dark:bg-gray-900" aria-label="submenu">
                                            ...
                                            <li>
                                                <div className="flex items-center font-serif py-1 text-sm text-gray-600 hover:text-blue-600 cursor-pointer" >
                                                    <span className="text-xs text-gray-500 pr-1">
                                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" stroke-linecap="square" stroke-linejoin="round" stroke-width="32" d="M400 256H112">
                                                        </path>
                                                        </svg>
                                                    </span>
                                                    <span className="text-gray-500 hover:text-blue-600 dark:hover:text-gray-200">Coupons</span>
                                                </div>
                                            </li>
                                        </ul>
                                    </>
