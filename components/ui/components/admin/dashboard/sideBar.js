      ...
      >
        <div className="py-4 text-gray-500 dark:text-gray-400 h-full">
          ...
          <div
            ...
            onClick={() => {
              sideBarComponentClicked("dashboard");
            }}
          >
          ...
          <ul className="mt-6">
                ...
                >
                  ...
                  <li>
                    <div
                      className="flex items-center font-serif py-2 text-sm text-gray-600 hover:text-blue-600 cursor-pointer"
                      onClick={() =>
                        sideBarComponentClicked("parentCategories")
                      }
                    >
                      <span
                        className="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg"
                  ...
                  <li>
                    <div className="flex items-center font-serif py-2 text-sm text-gray-600 hover:text-blue-600 cursor-pointer">
                      <span
                        className="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg"
                        aria-hidden="true"
                      ></span>
            ...
            <li className="relative px-6 py-3">
              <button
                className="inline-flex items-center justify-between focus:outline-none w-full text-sm font-semibold transition-colors duration-150 hover:text-blue-600 dark:hover:text-gray-200"
                aria-haspopup="true"
                onClick={() => setBannerButtonForm(!bannerButtonForm)}
              >
                <span className="inline-flex items-center">
                  <svg
                    stroke="currentColor"
                  ...
                  <span className="ml-4 mt-1">Banners</span>
                  <span className="pl-4 mt-1">
                    {bannerButtonForm ? (
                      <svg
                        stroke="currentColor"
              ...
              >
                ...
                >
                  ...
                  <li>
                    <div
                      className="flex items-center font-serif py-2 text-sm text-gray-600 hover:text-blue-600 cursor-pointer"
                      onClick={() => sideBarComponentClicked("video")}
                    >
                      <span
                        className="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg"
                        aria-hidden="true"
                  ...
                  <li>
                    <div
                      className="flex items-center font-serif py-2 text-sm text-gray-600 hover:text-blue-600 cursor-pointer"
                      onClick={() => sideBarComponentClicked("heroBanner")}
                    >
                      <span
                        className="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg"
                        aria-hidden="true"
            ...
            <li className="relative">
              <div
                className={`px-6 py-4 inline-flex items-center w-full text-sm font-semibold transition-colors hover:text-blue-600 cursor-pointer ${
                  pathName == "/admin/orders" ? "bg-blue-500 text-white" : ""
                } duration-150 dark:hover:text-gray-200`}
                target="_self"
                onClick={() => {
                  sideBarComponentClicked("orders");
                }}
              >
                <svg
                  stroke="currentColor"
