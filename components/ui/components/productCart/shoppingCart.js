              ...
              <div className="empty_cart_icon_text flex justify-center m-4">
                <div className="cart_icon text-center p-5">
                  <ProductionQuantityLimitsOutlinedIcon
                    style={{ fontSize: 100, opacity: 0.08 }}
                  />
                    ...
                    <div className="cart_text mx-4">
                      ...
                      <div className="quantity_section flex justify-start my-2">
                        <div className="inner flex">
                          {/* Minus Button */}
                          <button
                            className="border border px-2 py-1 hover:bg-gray-800 hover:text-white transition  hover:border-black text-gray-500 flex items-center justify-center"
                            onClick={() => {
                      ...
                      <div className="flex items-center my-2">
                        ...
                        <span className="m-1">
                          <svg
                            className="h-2 w-2 fill-gray-600"
                            viewBox="0 0 24 24"
                          >
            ...
            <div className="lower_section py-4 px-4 border-t border-gray-200 bg-white dark:bg-gray-800  w-full z-20">
              ...
              <div className="buttons_view_cart_and_checkout">
                <div className="view_cartbg text-black text-center bg-[#f7f7f7] mb-2.5 cursor-pointer w-full">
                  <Link href="/cart">
                    <button
                      className="text-center py-3 text-xs font-medium w-full"
                      onClick={toggleShoppingCart}
                    >
                      VIEW CART
                    </button>
