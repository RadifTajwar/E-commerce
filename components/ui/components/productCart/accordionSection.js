      ...
      <div className="border border-gray-200 mt-16 mb-4 px-4">
        ...
        <div className="hidden transition-all duration-500 ease-in-out">
          <div className="py-5 dark:border-gray-700">
            <ul
              className="text-sm text-gray-600 font-normal space-y-2 block"
          ...
          <p className="text-sm text-gray-600 font-normal space-y-2">
            Your everyday job will be easier if you keep all of your paperwork,
            file, documents, tabs up to 10 inches, checkbooks, certificates,
            business cards, and pencils in an A4 file bag. Cowhide is used to
            create the bag, which has a long lifespan.
          </p>
          <p className="text-sm text-gray-600 font-normal space-y-2">
            We ensure that your handmade leather goods is made to last a
            lifetime by incorporating quality throughout the whole production
            process. From our studio, we make full-grain leather goods using
            traditional leatherworking techniques and equipment.
          </p>
        </div>
