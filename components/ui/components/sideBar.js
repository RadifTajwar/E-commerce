...
export default function SideBar({
  ...
  const handleParentCategoryClicked = (
    parentCategoryId,
    parentCategoryName
  ) => {
    // Convert to lowercase and replace spaces with hyphens
    const formattedCategoryName = parentCategoryName
      .toLowerCase()
      .replace(/\s+/g, "-");
  ...
  return (
    <>
      <section
        className={`bg-white dark:bg-gray-900 min-h-screen flex items-center justify-center overflow-y-auto z-50  transition-transform duration-300 ${
        ...
        <div className="flex flex-col items-center h-screen justify-center  mx-auto w-full sm:max-w-xs ">
          <div className="w-full bg-white h-screen rounded-lg dark:border dark:bg-gray-800 dark:border-gray-700 overflow-y-auto">
            ...
            <div className="menu flex text-sm font-medium text-gray-500 dark:text-gray-400 bg-[#F5F5F5] cursor-pointer border-b border-gray-300">
              {/* MENU Tab */}
              <div
                className={`menu w-1/2 text-center px-4 py-5 relative group transition-colors duration-300 hover:text-black ${
                  isSelected ? "bg-[#E8E8E8] text-black" : "bg-[#F5F5F5]"
                }`}
                onClick={() => setIsSelected(true)}
              >
                MENU
                <span
                  className={`absolute bottom-0 right-0 w-0 h-0.5 bg-black transition-all duration-300  ${
                    isSelected
                      ? `w-full `
              ...
              {/* CATEGORIES Tab */}
              <div
                className={`categories w-1/2 text-center px-4 py-5 relative group transition-colors duration-300 hover:text-black ${
                  !isSelected ? "bg-[#E8E8E8] text-black" : "bg-[#F5F5F5]"
                }`}
              ...
              {isSelected ? (
                <>
                  {parentCategories?.map((parentCategory) => {
                    ...
                    const isExpanded =
                      expandedStates[parentCategory.id] || false;
                    ...
                    return (
                      <div key={parentCategory.id} className="overflow-scroll">
                        <div className="categoryItem flex justify-between text-gray-800 dark:text-gray-400 border-b border-gray-300 cursor-pointer text-[13px] font-semibold">
                          <div
                            className={`transition-all duration-200 category w-10/12 py-3 ps-5 border-e border-gray-300 ${
                              isExpanded ? "bg-[#F7F7F7]" : ""
                            }`}
                            onClick={() =>
                              handleParentCategoryClicked(
                                parentCategory.id,
                                parentCategory.name
                              )
                            }
                          ...
                          <div
                            className={`icon w-2/12 py-3 flex justify-center items-center space-x-2 transition-all duration-200 ${
                              isExpanded ? "bg-[#4C4C4C]" : "bg-[#F5F5F5]"
                            }`}
                  ...
                  <Link href="/shop">
                    <div
                      className="transition-all duration-200 category w-full py-3 ps-5 border-b border-gray-300 cursor-pointer text-[13px] font-semibold"
                  ...
                  {!isLoggedIn ? (
                    <div
                      className="transition-all duration-200 category w-full py-3 ps-5 border-b border-gray-300 cursor-pointer text-[13px] font-semibold flex items-center space-x-2"
                    ...
                    <>
                      <div className="categoryItem flex justify-between text-gray-800 dark:text-gray-400 border-b border-gray-300 cursor-pointer text-[13px] font-semibold">
                        <div
                          className={`transition-all duration-200 category w-10/12 py-3 ps-5 border-e border-gray-300 flex items-center space-x-2 ${
                            toggleAccountExpanded ? "bg-[#F7F7F7]" : ""
                          }`}
                        >
                          <User className="w-5 h-5" />
                          MY ACCOUNT
                        ...
                        <div
                          ...
                          onClick={() =>
                            setToggleAccountExpanded(!toggleAccountExpanded)
                          }
                        >
                          <ChevronRightIcon
                            fontSize="medium"
                      ...
                      {toggleAccountExpanded && (
                        <div className="overflow-hidden transition-all duration-200">
                          ...
                          <div
                            className="py-4 px-5 text-gray-400 dark:text-gray-300 border-b border-gray-300 cursor-pointer text-[13px] font-regular transition-all duration-300 hover:text-gray-800"
                            onClick={() =>
                              handleUserMenuClicked("/myAccount/orders")
                            }
                          >
                            Orders
                          </div>
                          <div
                            className="py-4 px-5 text-gray-400 dark:text-gray-300 border-b border-gray-300 cursor-pointer text-[13px] font-regular transition-all duration-300 hover:text-gray-800"
                            onClick={() =>
                              handleUserMenuClicked("/myAccount/editAddress")
                            }
                          >
                            Addresses
                          </div>
                          <div
                            className="py-4 px-5 text-gray-400 dark:text-gray-300 border-b border-gray-300 cursor-pointer text-[13px] font-regular transition-all duration-300 hover:text-gray-800"
                            onClick={() =>
                              handleUserMenuClicked("/myAccount/editAccount")
                            }
                          >
                            Account
                          </div>
                ...
                parentCategories?.map((parentCategory) => (
                  ...
                  >
                    <div className="w-10/12 py-3 ps-5">
                      {parentCategory.name}
                    </div>
                  </div>
                ))
